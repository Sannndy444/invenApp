...
if (isset($_GET['type_id'])) {
    ...
    $sql = "SELECT type_id, type_name FROM types WHERE type_id = ?";
    $stmt = $db->prepare($sql);
...
<body>
    <div class="editType-container">
        ...
        <div class="editType">
            ...
            <div class="content">
                <form action="../proces/editType.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="type_id" value="<?php echo $typeId; ?>">
                    <div class="form-group">
                        <label for="editType">Type Name</label>
                        <input type="text" name="editType" id="editType" value="<?php echo $type['type_name']; ?>" required>
                    </div>
                    <div class="form-group">
