...
if (isset($_GET['location_id'])) {
    ...
    $sql = "SELECT location_id, location_name FROM location WHERE location_id = ?";
    $stmt = $db->prepare($sql);
...
<body>
    <div class="editLocation-container">
        <div class="navbar">
        ...
        <div class="editLocation">
            ...
            <div class="content">
                <form action="../proces/editLocation.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="location_id" value="<?php echo $locationId; ?>">
                    <div class="form-group">
                        <label for="editLocation">Location Name</label>
                        <input type="text" name="editLocation" id="editLocation" value="<?php echo $location['location_name']; ?>" required>
                    </div>
                    <div class="form-group">
